...
<body>
        ...
        <div class="stage-container">
            <div class="stage cleared">
                <div class="stage-icon">
                    <img src="Assets\Icon\flag.svg" alt="Edit" fill=#FFD233>
                </div>
            ...
            <div class="stage cleared">
                <div class="stage-icon">
                    <img src="Assets\Icon\flag.svg" alt="Edit">
                </div>
    ...
    <script>
        document.getElementById('back').addEventListener('click', function() {
            var lobbyId = this.getAttribute('data-lobby-id');
            window.location.href = 'lobby1.php?lobbyID=' + lobbyId;
    });
